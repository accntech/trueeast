...
export const services: Service[] = [
	{
		...
		body: 'Roof-mounted solar installations connected directly to the power grid. The array carries your daytime load, the grid covers the rest — businesses and households see a lower electricity bill and a lighter dependence on the utility, with no batteries to maintain.',
		points: [
	...
	},
	{
		...
		summary: 'Solar paired with battery storage — energy security through every brownout.',
...
export const process: ProcessStep[] = [
	{
		n: '01',
		title: 'Engineering',
		body: 'A registered electrical engineer assesses the site, the load profile and the structure — every system is sized to the building, not a catalogue.'
	},
	{
		n: '02',
		title: 'Design',
...
export const advantages = [
	...
	},
	{
		...
		body: 'Founded out of a rice-mill fighting its own electricity costs — the savings case is lived, not pitched.'
	},
	{
